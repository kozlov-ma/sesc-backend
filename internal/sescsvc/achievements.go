...
func (s *SESC) GenerateUserPointsReport(ctx context.Context) (*bytes.Buffer, error) {
...
func (s *SESC) queryAllUsersForReport(ctx context.Context, rec *event.Record, queryCount *int) ([]*ent.User, error) {
	var users []*ent.User
...
func (s *SESC) calculateUserPointsData(
	ctx context.Context,
	rec *event.Record,
	users []*ent.User,
	queryCount *int,
...
func (s *SESC) getUserTotalPoints(
	ctx context.Context,
	userID uuid.UUID,
...
func (s *SESC) formatUserFullName(usr *ent.User) string {
...
func (s *SESC) getUserSubdivision(usr *ent.User) string {
...
func (s *SESC) setExcelHeaders(file *excelize.File, sheetName string, opRec *event.Record) error {
...
func (s *SESC) setExcelData(file *excelize.File, sheetName string, reportData []userReport, opRec *event.Record) error {
...
func (s *SESC) MarkAchievementsAsAccounted(ctx context.Context, achievementIDs []uuid.UUID) error {
