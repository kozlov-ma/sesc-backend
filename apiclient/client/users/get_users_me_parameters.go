...
// WithAuthorization adds the authorization to the get users me params
func (o *GetUsersMeParams) WithAuthorization(authorization *string) *GetUsersMeParams {
	o.SetAuthorization(authorization)
	return o
}

// SetAuthorization adds the authorization to the get users me params
func (o *GetUsersMeParams) SetAuthorization(authorization *string) {
