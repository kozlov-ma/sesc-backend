...
// WithAuthorization adds the authorization to the get users ID params
func (o *GetUsersIDParams) WithAuthorization(authorization *string) *GetUsersIDParams {
	o.SetAuthorization(authorization)
	return o
}

// SetAuthorization adds the authorization to the get users ID params
func (o *GetUsersIDParams) SetAuthorization(authorization *string) {
