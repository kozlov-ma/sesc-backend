...
type PatchUsersIDParams struct {
	...
	*/
	Request *models.APIPatchUserRequest
...
// WithAuthorization adds the authorization to the patch users ID params
func (o *PatchUsersIDParams) WithAuthorization(authorization *string) *PatchUsersIDParams {
	o.SetAuthorization(authorization)
	return o
}

// SetAuthorization adds the authorization to the patch users ID params
func (o *PatchUsersIDParams) SetAuthorization(authorization *string) {
...
// WithRequest adds the request to the patch users ID params
func (o *PatchUsersIDParams) WithRequest(request *models.APIPatchUserRequest) *PatchUsersIDParams {
	o.SetRequest(request)
	return o
}

// SetRequest adds the request to the patch users ID params
func (o *PatchUsersIDParams) SetRequest(request *models.APIPatchUserRequest) {
	o.Request = request
}
