...
type PostUsersParams struct {
	...
	*/
	...
	/* Request.
	   ...
	   User details
	*/
	Request *models.APICreateUserRequest
...
// WithRequest adds the request to the post users params
func (o *PostUsersParams) WithRequest(request *models.APICreateUserRequest) *PostUsersParams {
	o.SetRequest(request)
	return o
}

// SetRequest adds the request to the post users params
func (o *PostUsersParams) SetRequest(request *models.APICreateUserRequest) {
	o.Request = request
}
