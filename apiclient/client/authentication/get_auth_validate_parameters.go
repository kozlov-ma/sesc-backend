...
// WithAuthorization adds the authorization to the get auth validate params
func (o *GetAuthValidateParams) WithAuthorization(authorization *string) *GetAuthValidateParams {
	o.SetAuthorization(authorization)
	return o
}

// SetAuthorization adds the authorization to the get auth validate params
func (o *GetAuthValidateParams) SetAuthorization(authorization *string) {
