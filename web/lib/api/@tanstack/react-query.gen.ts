...
export const postDocumentsScheduleDeletionAllOptions = (
  ...
  return queryOptions({
    ...
    queryKey: postDocumentsScheduleDeletionAllQueryKey(options),
  });
};
...
export const postDocumentsScheduleDeletionAllMutation = (
  ...
  unknown,
  AxiosError<PostDocumentsScheduleDeletionAllError>,
  Options<PostDocumentsScheduleDeletionAllData>
> => {
  const mutationOptions: UseMutationOptions<
    unknown,
    AxiosError<PostDocumentsScheduleDeletionAllError>,
...
export const getDocumentsStatsQueryKey = (
  options?: Options<GetDocumentsStatsData>,
) => createQueryKey("getDocumentsStats", options);
...
export const getDocumentsStatsOptions = (
  ...
  return queryOptions({
    ...
    queryKey: getDocumentsStatsQueryKey(options),
  });
};
