...
func AcademicDegree(v sesc.AcademicDegree) predicate.User {
	vc := int(v)
	return predicate.User(sql.FieldEQ(FieldAcademicDegree, vc))
}

// PersonnelCategory applies equality check predicate on the "personnel_category" field. It's identical to PersonnelCategoryEQ.
func PersonnelCategory(v sesc.PersonnelCategory) predicate.User {
	vc := int(v)
	return predicate.User(sql.FieldEQ(FieldPersonnelCategory, vc))
}

// EmploymentType applies equality check predicate on the "employment_type" field. It's identical to EmploymentTypeEQ.
func EmploymentType(v sesc.EmploymentType) predicate.User {
	vc := int(v)
	return predicate.User(sql.FieldEQ(FieldEmploymentType, vc))
}
...
func AcademicDegreeEQ(v sesc.AcademicDegree) predicate.User {
	vc := int(v)
	return predicate.User(sql.FieldEQ(FieldAcademicDegree, vc))
}

// AcademicDegreeNEQ applies the NEQ predicate on the "academic_degree" field.
func AcademicDegreeNEQ(v sesc.AcademicDegree) predicate.User {
	vc := int(v)
	return predicate.User(sql.FieldNEQ(FieldAcademicDegree, vc))
}

// AcademicDegreeIn applies the In predicate on the "academic_degree" field.
func AcademicDegreeIn(vs ...sesc.AcademicDegree) predicate.User {
	v := make([]any, len(vs))
	for i := range v {
		v[i] = int(vs[i])
	}
	return predicate.User(sql.FieldIn(FieldAcademicDegree, v...))
}

// AcademicDegreeNotIn applies the NotIn predicate on the "academic_degree" field.
func AcademicDegreeNotIn(vs ...sesc.AcademicDegree) predicate.User {
	v := make([]any, len(vs))
	for i := range v {
		v[i] = int(vs[i])
	}
	return predicate.User(sql.FieldNotIn(FieldAcademicDegree, v...))
}

// AcademicDegreeGT applies the GT predicate on the "academic_degree" field.
func AcademicDegreeGT(v sesc.AcademicDegree) predicate.User {
	vc := int(v)
	return predicate.User(sql.FieldGT(FieldAcademicDegree, vc))
}

// AcademicDegreeGTE applies the GTE predicate on the "academic_degree" field.
func AcademicDegreeGTE(v sesc.AcademicDegree) predicate.User {
	vc := int(v)
	return predicate.User(sql.FieldGTE(FieldAcademicDegree, vc))
}

// AcademicDegreeLT applies the LT predicate on the "academic_degree" field.
func AcademicDegreeLT(v sesc.AcademicDegree) predicate.User {
	vc := int(v)
	return predicate.User(sql.FieldLT(FieldAcademicDegree, vc))
}

// AcademicDegreeLTE applies the LTE predicate on the "academic_degree" field.
func AcademicDegreeLTE(v sesc.AcademicDegree) predicate.User {
	vc := int(v)
	return predicate.User(sql.FieldLTE(FieldAcademicDegree, vc))
}

// AcademicDegreeIsNil applies the IsNil predicate on the "academic_degree" field.
func AcademicDegreeIsNil() predicate.User {
	return predicate.User(sql.FieldIsNull(FieldAcademicDegree))
}

// AcademicDegreeNotNil applies the NotNil predicate on the "academic_degree" field.
func AcademicDegreeNotNil() predicate.User {
	return predicate.User(sql.FieldNotNull(FieldAcademicDegree))
}

// PersonnelCategoryEQ applies the EQ predicate on the "personnel_category" field.
func PersonnelCategoryEQ(v sesc.PersonnelCategory) predicate.User {
	vc := int(v)
	return predicate.User(sql.FieldEQ(FieldPersonnelCategory, vc))
}

// PersonnelCategoryNEQ applies the NEQ predicate on the "personnel_category" field.
func PersonnelCategoryNEQ(v sesc.PersonnelCategory) predicate.User {
	vc := int(v)
	return predicate.User(sql.FieldNEQ(FieldPersonnelCategory, vc))
}

// PersonnelCategoryIn applies the In predicate on the "personnel_category" field.
func PersonnelCategoryIn(vs ...sesc.PersonnelCategory) predicate.User {
	v := make([]any, len(vs))
	for i := range v {
		v[i] = int(vs[i])
	}
	return predicate.User(sql.FieldIn(FieldPersonnelCategory, v...))
}

// PersonnelCategoryNotIn applies the NotIn predicate on the "personnel_category" field.
func PersonnelCategoryNotIn(vs ...sesc.PersonnelCategory) predicate.User {
	v := make([]any, len(vs))
	for i := range v {
		v[i] = int(vs[i])
	}
	return predicate.User(sql.FieldNotIn(FieldPersonnelCategory, v...))
}

// PersonnelCategoryGT applies the GT predicate on the "personnel_category" field.
func PersonnelCategoryGT(v sesc.PersonnelCategory) predicate.User {
	vc := int(v)
	return predicate.User(sql.FieldGT(FieldPersonnelCategory, vc))
}

// PersonnelCategoryGTE applies the GTE predicate on the "personnel_category" field.
func PersonnelCategoryGTE(v sesc.PersonnelCategory) predicate.User {
	vc := int(v)
	return predicate.User(sql.FieldGTE(FieldPersonnelCategory, vc))
}

// PersonnelCategoryLT applies the LT predicate on the "personnel_category" field.
func PersonnelCategoryLT(v sesc.PersonnelCategory) predicate.User {
	vc := int(v)
	return predicate.User(sql.FieldLT(FieldPersonnelCategory, vc))
}

// PersonnelCategoryLTE applies the LTE predicate on the "personnel_category" field.
func PersonnelCategoryLTE(v sesc.PersonnelCategory) predicate.User {
	vc := int(v)
	return predicate.User(sql.FieldLTE(FieldPersonnelCategory, vc))
}

// EmploymentTypeEQ applies the EQ predicate on the "employment_type" field.
func EmploymentTypeEQ(v sesc.EmploymentType) predicate.User {
	vc := int(v)
	return predicate.User(sql.FieldEQ(FieldEmploymentType, vc))
}

// EmploymentTypeNEQ applies the NEQ predicate on the "employment_type" field.
func EmploymentTypeNEQ(v sesc.EmploymentType) predicate.User {
	vc := int(v)
	return predicate.User(sql.FieldNEQ(FieldEmploymentType, vc))
}

// EmploymentTypeIn applies the In predicate on the "employment_type" field.
func EmploymentTypeIn(vs ...sesc.EmploymentType) predicate.User {
	v := make([]any, len(vs))
	for i := range v {
		v[i] = int(vs[i])
	}
	return predicate.User(sql.FieldIn(FieldEmploymentType, v...))
}

// EmploymentTypeNotIn applies the NotIn predicate on the "employment_type" field.
func EmploymentTypeNotIn(vs ...sesc.EmploymentType) predicate.User {
	v := make([]any, len(vs))
	for i := range v {
		v[i] = int(vs[i])
	}
	return predicate.User(sql.FieldNotIn(FieldEmploymentType, v...))
}

// EmploymentTypeGT applies the GT predicate on the "employment_type" field.
func EmploymentTypeGT(v sesc.EmploymentType) predicate.User {
	vc := int(v)
	return predicate.User(sql.FieldGT(FieldEmploymentType, vc))
}

// EmploymentTypeGTE applies the GTE predicate on the "employment_type" field.
func EmploymentTypeGTE(v sesc.EmploymentType) predicate.User {
	vc := int(v)
	return predicate.User(sql.FieldGTE(FieldEmploymentType, vc))
}

// EmploymentTypeLT applies the LT predicate on the "employment_type" field.
func EmploymentTypeLT(v sesc.EmploymentType) predicate.User {
	vc := int(v)
	return predicate.User(sql.FieldLT(FieldEmploymentType, vc))
}

// EmploymentTypeLTE applies the LTE predicate on the "employment_type" field.
func EmploymentTypeLTE(v sesc.EmploymentType) predicate.User {
	vc := int(v)
	return predicate.User(sql.FieldLTE(FieldEmploymentType, vc))
}
...
// AcademicTitleIsNil applies the IsNil predicate on the "academic_title" field.
func AcademicTitleIsNil() predicate.User {
	return predicate.User(sql.FieldIsNull(FieldAcademicTitle))
}

// AcademicTitleNotNil applies the NotNil predicate on the "academic_title" field.
func AcademicTitleNotNil() predicate.User {
	return predicate.User(sql.FieldNotNull(FieldAcademicTitle))
}
...
// HonorsIsNil applies the IsNil predicate on the "honors" field.
func HonorsIsNil() predicate.User {
	return predicate.User(sql.FieldIsNull(FieldHonors))
}

// HonorsNotNil applies the NotNil predicate on the "honors" field.
func HonorsNotNil() predicate.User {
	return predicate.User(sql.FieldNotNull(FieldHonors))
}
...
func CategoryIsNil() predicate.User {
	return predicate.User(sql.FieldIsNull(FieldCategory))
}

// CategoryNotNil applies the NotNil predicate on the "category" field.
func CategoryNotNil() predicate.User {
	return predicate.User(sql.FieldNotNull(FieldCategory))
}
...
func HasReviewsWith(preds ...predicate.AchievementReview) predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := newReviewsStep()
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {
