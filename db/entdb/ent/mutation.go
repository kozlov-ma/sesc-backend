...
func (m *FileMutation) SetFileSize(i int) {
	m.file_size = &i
	m.addfile_size = nil
}

// FileSize returns the value of the "file_size" field in the mutation.
func (m *FileMutation) FileSize() (r int, exists bool) {
	v := m.file_size
	if v == nil {
		return
	}
...
// If the File object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *FileMutation) OldFileSize(ctx context.Context) (v int, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *FileMutation) AddFileSize(i int) {
...
func (m *FileMutation) AddedFileSize() (r int, exists bool) {
	v := m.addfile_size
	if v == nil {
		return
	}
...
// If the User object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *UserMutation) OldAcademicDegree(ctx context.Context) (v int, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *UserMutation) AddAcademicDegree(i int) {
	if m.addacademic_degree != nil {
		*m.addacademic_degree += i
	} else {
		m.addacademic_degree = &i
	}
}
...
func (m *UserMutation) AddedAcademicDegree() (r int, exists bool) {
