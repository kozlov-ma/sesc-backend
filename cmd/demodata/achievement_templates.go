...
import "github.com/kozlov-ma/sesc-backend/achievement"
	...
	"Показатель № 1": {
		{
			...
			PointsLimit: 10,
			Kind:        string(achievement.Development),
		},
		{
	...
	"Показатель № 4.1": {
		{
			...
			PointsLimit: 10,
			Kind:        string(achievement.Scientific),
		},
		{
	...
	"Показатель № 6": {
		{
			...
			PointsLimit: 10,
			Kind:        string(achievement.Olympiad),
		},
		{
